...
function UserOnlyRoute({ children }) {
  ...
  if (user?.role === 'admin' || user?.role === 'escrow') {
...
export default function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/upload" element={<UserOnlyRoute><UploadProduct /></UserOnlyRoute>} />
      <Route path="/messages" element={<ProtectedRoute><Messages /></ProtectedRoute>} />
      <Route path="/messages/:txId" element={<ProtectedRoute><Chat /></ProtectedRoute>} />
      <Route path="/profile" element={<UserOnlyRoute><Profile /></UserOnlyRoute>} />
      <Route path="/favorites" element={<UserOnlyRoute><Favorites /></UserOnlyRoute>} />
