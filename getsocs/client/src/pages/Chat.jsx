...
export default function Chat() {
  ...
  return (
    <div className={`chat-page ${selectedTx ? 'has-selected-tx' : ''}`}>
            ...
            <>
              ...
              <div className="deal-specs-card">
                <div className="deal-specs-title">
                  Request to purchase &quot;<a href={selectedTx.productUrl || '#'} target="_blank" rel="noreferrer">{selectedTx.productTitle}</a>&quot;
                </div>
                <div className="deal-specs-body">
                  <div><strong>Transaction ID:</strong> {selectedTx.id}</div>
                  <div><strong>Transaction amount:</strong> {formatCurrency(selectedTx.totalPrice || selectedTx.productPrice)}</div>
                  <div><strong>Transfer to:</strong> {selectedTx.sellerEmail || selectedTx.sellerName || 'Seller'}</div>
                </div>
                <div className="deal-specs-steps-caption">Transaction steps when using the escrow service:</div>
                <ol className="deal-specs-steps">
                  <li>The buyer pays the cost of the channel plus 4–8% ($3 minimum) service fee.</li>
                  ...
                  <li>After 7 days, the escrow agent removes all the other managers and assigns primary ownership rights to the buyer.</li>
            ...
            {otherProfile && !otherProfile.hidden && (
              <div className="chat-info-rows">
                <div className="chat-info-row">
                  ...
                  <span>{otherProfile.idVerified ? '✅ Yes' : '— No'}</span>
                </div>
                <div className="chat-info-row">
