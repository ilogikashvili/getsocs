    ...
    <div className="notifications-page">
      ...
      <div className="notifications-layout">
        <section className="notifications-list-card" aria-label="Notification list">
          ...
          {!loading && error && <div className="notifications-empty-state" role="alert"><strong>{error}</strong><p>Refresh the page to try again.</p></div>}
          {!loading && !error && filteredNotifications.map(item => <NotificationRow key={item.id} item={item} />)}
